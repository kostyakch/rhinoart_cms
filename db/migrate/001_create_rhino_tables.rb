class CreateRhinoTables < ActiveRecord::Migration[5.1]
  def self.up
    ...
    add_index :rhinoart_pages, %i[parent_id slug], unique: true
    ...
    add_index :rhinoart_page_contents, %i[page_id name], unique: true
    ...
    add_index :rhinoart_page_fields, %i[page_id name], unique: true, name: 'page_fields_page_id_and_name'
